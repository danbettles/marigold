...
class FilesystemUtils
{
     ...
     *   extension.  (The value will be an empty string if the pathname has a blank extension.)
     * PATHINFO_EXTENSION:
     *   `null` if the pathname contains no extension.  (An empty string if the pathname has a blank extension.)
     *
